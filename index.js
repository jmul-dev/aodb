...
HyperDB.prototype.put = function (key, val, signature, pub_key, opts, cb) { ////////////////////////////////////////////////////////////
  //if (typeof opts === 'function') return this.put(key, val, null, opts)
  if (typeof opts === 'function') return this.put(key, val, signature, pub_key, null, opts) ////////////////////////////////////////////////////////////////////////
  if (!cb) cb = noop
  ...
  this._lock(function (release) {
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		const signer = EthCrypto.recoverPublicKey(signature, EthCrypto.hash.keccak256(val));
...
HyperDB.prototype.get = function (key, pub_key, opts, cb) {
  //if (typeof opts === 'function') return this.get(key, null, opts)
  if (typeof opts === 'function') return this.get(key, pub_key, null, opts) //////////////////////////////////////////////
  ...
  this._getHeads((opts && opts.update) !== false, function (err, heads) {
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//const signer = EthCrypto.recoverPublicKey(heads[0].signature, EthCrypto.hash.keccak256(heads[0].value));

	//if(signer == pub_key) {
		get(self, heads, normalizeKey(key), opts, cb)
	//}else{
		//return unlock('signer does not match address and therefore does not have access to this record');
		//throw 'signer does not match address and therefore does not have access to this record'
	//}
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//get(self, heads, normalizeKey(key), opts, cb)
  })
...
Writer.prototype.append = function (entry, cb) {
  ...
  var mapped = {
    key: entry.key,
    value: null,
	signature: entry.signature, //////////////////////////////////////// works to here ////////////////////////
