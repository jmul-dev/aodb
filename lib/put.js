...
function put (db, clock, heads, key, value, signature, pub_key, opts, cb) {  ///////////////////////////////////////////////////////////////////////
  //if (typeof opts === 'function') return put(db, clock, heads, key, value, null, opts)
  if (typeof opts === 'function') return put(db, clock, heads, key, value, signature, pub_key, null, opts)

  //var req = new PutRequest(db, key, value, clock, opts)
  var req = new PutRequest(db, key, value, signature, pub_key, clock, opts) ///////////////////////////////////////////////////////////
...
function PutRequest (db, key, value, signature, pub_key, clock, opts) { //////////////////////////////////////////////////////////
  this.key = key
  this.value = value
  this.signature = signature ///////////////////////////////////////////////////////////////////////////////////////////////////////
  this.writerAddress = pub_key ///////////////////////////////////////////////////////////////////////////////////////////////////
...
PutRequest.prototype._finalize = function () {
  ...
  var node = {
    key: this.key,
    value: this.value,
	signature: this.signature, ///////////////////////////////////////////////////////////////////////////// THIS IS WORKING :) :) :) ///////////////
