...
function defineEntry () {
  ...
  function encodingLength (obj) {
    ...
    var len = enc[1].encodingLength(obj.writerAddress)
    length += 1 + len
    return length
  }
  ...
  function encode (obj, buf, offset) {
    ...
    if (!defined(obj.writerAddress)) throw new Error("writerAddress is required")
    buf[offset++] = 82
    enc[1].encode(obj.writerAddress, buf, offset)
    offset += enc[1].encode.bytes
  ...
  function decode (buf, offset, end) {
    ...
    while (true) {
      if (end <= offset) {
        if (!found0 || !found3 || !found6 || !found7) throw new Error("Decoded message is not valid")
      ...
      switch (tag) {
        ...
        break
        case 10:
        obj.writerAddress = enc[1].decode(buf, offset)
        offset += enc[1].decode.bytes
        found7 = true
        break
        default:
...
function defineInflatedEntry () {
  ...
  function decode (buf, offset, end) {
    ...
    while (true) {
      if (end <= offset) {
        if (!found0 || !found3 || !found8 || !found9) throw new Error("Decoded message is not valid")
        decode.bytes = offset - oldOffset
        return obj
      }
      var prefix = varint.decode(buf, offset)
