...
function defineEntry () {
  ...
  function encodingLength (obj) {
	...
	if(defined(obj.signature)) {
		var len = enc[4].encodingLength(obj.signature)
		length += 1 + len;
	}
	if(defined(obj.writerAddress)) {
		var len = enc[5].encodingLength(obj.writerAddress)
		length += 1 + len;
	}
	////////////////////////////////////////////////////////////////////////////////////////
    return length
  ...
  function encode (obj, buf, offset) {
	...
	if(defined(obj.signature)) {
		buf[offset++] = 56;
		enc[4].encode(obj.signature, buf, offset);
		offset += enc[4].encode.bytes;
	}
	if(defined(obj.writerAddress)) {
		buf[offset++] = 64;
		enc[5].encode(obj.writerAddress, buf, offset);
  ...
  function decode (buf, offset, end) {
    ...
    while (true) {
      ...
      switch (tag) {
		...
		/////////////////////////////////////////////////////////////////////
		case 7:
        obj.signature = enc[4].decode(buf, offset);
        offset += enc[4].decode.bytes;
        break;
		case 8:
        obj.writerAddress = enc[5].decode(buf, offset);
